...
export async function getNegociosByUsuario(id_usuario: bigint | number) {
  try {
    ...
    return negocios.map(negocio => ({
      ...
      id_usuario: negocio.fk_usuario.toString(),
    }));
  } catch (error) {
...
export async function createNegocio(data: {
  ...
  try {
    ...
    return {
      ...
      id_usuario: nuevoNegocio.fk_usuario.toString(),
    };
  } catch (error) {
...
export async function updateNegocio(
  ...
  try {
    ...
    return {
      ...
      id_usuario: negocioActualizado.fk_usuario.toString(),
    };
  } catch (error) {
...
export async function deleteNegocio(id: bigint | number | string) {
  try {
    ...
    return {
      ...
      id_usuario: negocioEliminado.fk_usuario.toString(),
    };
  } catch (error) {
